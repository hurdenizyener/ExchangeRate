...
namespace Business.Concrete
{
    public class SecondExchangeRateManager : ISecondExchangeRateService
    {
        ...
        public SecondExchangeRateManager(HttpClient httpClient, ISecondExchangeRateRepository secondExchangeRateRepository, ISecondExchangeRepository secondExchangeRepository)
        {
